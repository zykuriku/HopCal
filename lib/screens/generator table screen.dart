...
class GenTableScreen extends StatefulWidget {
  const GenTableScreen({super.key});

  @override
  State<GenTableScreen> createState() => _GenTableScreenState();
}

class _GenTableScreenState extends State<GenTableScreen> {
  GenListController myController = Get.put(GenListController());
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: FloatingActionButton(onPressed: (){
                  Get.toNamed('/graph',arguments: "generator");
                },backgroundColor: Colors.redAccent,
                  child: Container(
